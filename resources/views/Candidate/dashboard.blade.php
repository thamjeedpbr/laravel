...
<body
                    ...
                    <div class="d-flex justify-content-between align-items-center cspt-header-content">
                        ...
                        <div class="cspt-right-box">
                            ...
                            <div class="cspt-header-button">
                                <a href="{{ route('logout') }}">
                                    <span class="cspt-header-button-text-1">Logout<small>{{ Auth::user()->name }}</small></span> </a>
                            </div>
                        </div>
                    </div><!-- .justify-content-between -->
                        ...
                        <div class="cspt-title-bar-content-inner">
                            <div class="cspt-tbar">
                                <div class="cspt-tbar-inner container">
                                    <h1 class="cspt-tbar-title"> Registration Dashboard</h1>
                                </div>
                            </div>
                            <div class="cspt-breadcrumb">
                                <div class="cspt-breadcrumb-inner"><span><a title="Go to Lantern Abroad."
                                            ...
                                            class="post post-page current-item">Candidate Dashboard</span></span></div>
                            </div>
                        </div>
                                            ...
                                            <div class="elementor-container elementor-column-gap-default">
                                                <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-13660e6 cspt-bg-color-over-image"
                                                    ...
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        <div
                                                            class="elementor-element elementor-element-8f9a2ec elementor-widget elementor-widget-heading">
                                                                            ...
                                                                            <div id="profile-log-switch">
                                                                                <div class="table-responsive ">
                                                                                    <div class="col-md">
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            <form
                                                                                                action="{{ route('candidate.upload.docs') }}"
                                                                                                method="POST"
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        @foreach ($files as $file)
                                                                                                            <div
                                                                                                                class="form-group overflow-hidden">
                                                                                                                <div
                                                                                                                    class="form-group">
                                                                                                                    <h5>{{ $file->name }}
                                                                                                                        </h3>
                                                                                                            ...
                                                                                                            <h5>Immigration
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        class="form-control"
                                                                                                                        name="immigration_advise"
                                                                                                                        value="{{ $candidate->immigration_advise }}"
                                                                                                                ...
                                                                                                                <h5>Need
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                            type="text"
                                                                                                                            class="form-control"
                                                                                                                            name="airport_accommodation"
                                                                                                                            value="{{ $candidate->airport_accommodation }}"
                                                                                                                            placeholder="Immigration Advise">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12">
                                                                            <div class="wideget-user-desc d-flex">
                                                                                <div class="user-wrap">
                                                                                    ...
                                                                                    <h6 class="text-muted mb-3">Contact
                                                                                    ...
                                                                                    <h6 class="text-muted mb-3">Status:
                                                                                        {{ $candidate->status_text }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        username:
                                                                                        {{ $candidate->username }}</h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        qualification:
                                                                                    ...
                                                                                    <h6 class="text-muted mb-3">
                                                                                        OET_or_IELTS_Score:
                                                                                        {{ $candidate->OET_or_IELTS_Score }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        CGFNS_status:
                                                                                        {{ $candidate->CGFNS_status }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        New_Zealand_nursing_council:
                                                                                        {{ $candidate->New_Zealand_nursing_council }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        preferred_Campus:
                                                                                        {{ $candidate->preferred_Campus }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        Preferred_intake:
                                                                                        {{ $candidate->Preferred_intake }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        refereal_method:
                                                                                        {{ $candidate->refereal_method }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        Friends_Family_NZ_status:
                                                                                        {{ $candidate->Friends_Family_NZ_status }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        Friends_Family_NZ:
                                                                                        {{ $candidate->Friends_Family_NZ }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">email:
                                                                                        {{ $candidate->email }}</h6>
                                                                                    <h6 class="text-muted mb-3">phone:
                                                                                        {{ $candidate->phone }}</h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        street_address:
                                                                                    ...
                                                                                    <h6 class="text-muted mb-3">
                                                                                        working:
                                                                                        {{ $candidate->working }}</h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        working_address_india:
                                                                                        {{ $candidate->working_address_india }}
                                                                                    </h6>
                                                                                    <h6 class="text-muted mb-3">
                                                                                        Cover_letter:
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="cspt-footer-widget cspt-footer-widget-col-4 col-md-6 col-lg-3">
                            <aside id="text-4" class="widget widget_text emphires_widget  emphires_widget_count_5">
                                <h2 class="widget-title">ADDRESS</h2>
                                <div class="textwidget">
                            ...
                            <aside id="text-5" class="widget widget_text emphires_widget  emphires_widget_count_6">
            ...
            <div class="cspt-footer-text-area  cspt-bg-color-transparent">
                <div class="container">
                    <div class="cspt-footer-text-inner">
                        ...
                        <a href="#" class="scroll-to-top"><i class="cspt-base-icon-arrow-right"></i><span
                                class="cspt-hide">Back to
                                top</span></a>
                    </div>
                </div>
    ...
    <link rel='stylesheet' id='buttons-css' href='http://lanternabroad.com/wp-includes/css/buttons.min.css?ver=6.2'
        type='text/css' media='all' />

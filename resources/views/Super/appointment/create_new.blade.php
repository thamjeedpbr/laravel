        ...
        <div class="row">
            <div class="col-md">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body">
                        <form action="{{ route('appointment.save_new') }}" method="POST" class="form-prevent-multiple-submits">
                            @csrf
                            @method('POST')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group overflow-hidden">
                                        <label>Summary</label>
                                        <div class="form-group">
                                            <textarea class="form-control  col-md-12" name="summary" id="summary" required>{{ old('summary') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group overflow-hidden">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control  col-md-12" name="location" id="location">{{ old('location') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<head>
    ...
    <meta content="Fixerman – Delivery Admin Pannel" name="description">
    ...
    <!-- TITLE -->
    <title>Fixerman – Admin Pannel</title>
    ...
    <!-- Skin css-->
    <link href="{{ asset('assets/skins/skins-modes/color1.css') }}" id="theme" rel="stylesheet" type="text/css"
        media="all" />
